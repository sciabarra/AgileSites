...
set BASE=%~dp0
set REPLACE=%BASE:\=/%
set SETUP="%JAVA_HOME%"\bin\java -cp "%BASE%\bin\setup.jar"
%BDRV%
cd "%BASE%"
del home\*.done
...
%SETUP% setup.Silent %BASE% misc\silentinstaller\generic_omii.ini Sites\install.ini Sites\omii.ini %HOST% %PORT% %DB% 
