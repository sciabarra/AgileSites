...
<%//
// OpenMarket/Xcelerate/AssetType/DimensionSet/ShowEnabledDimensionForm
//
// INPUT
//
// OUTPUT
...
<ics:then>
	...
	<tr>
		...
		<td />
		<td class="form-inset"><ics:callelement element="OpenMarket/Xcelerate/AssetType/DimensionSet/PickEnabledDimensionForm"/></td>
	</tr>
</ics:then>
</ics:if>
</ics:then>
