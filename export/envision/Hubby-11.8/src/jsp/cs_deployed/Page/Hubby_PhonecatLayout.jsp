...
%><% // -----------------------------------------------------
%><%=seq.header()%><%
} catch(Throwable ex) { log.error(ex, "jsp.hubby.element.page.PhonecatLayout"); } }
%></cs:ftcs>