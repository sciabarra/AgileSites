...
%><% // -----------------------------------------------------
%><%=seq.header()%><%
} catch(Throwable ex) { log.error(ex, "jsp.mysite.element.page.ContentLayout"); } }
%></cs:ftcs>