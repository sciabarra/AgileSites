...
%><% // -----------------------------------------------------
%><%=seq.header()%><%
} catch(Throwable ex) { log.error(ex, "jsp.mysite.element.page.ContentDetail"); } }
%></cs:ftcs>