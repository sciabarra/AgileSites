...
%><% // -----------------------------------------------------
%><%=seq.header()%><%
} catch(Throwable ex) { log.error(ex, "jsp.mysite.element.Tester"); } }
%></cs:ftcs>