...
java -Xms128m -Xmx512m -Xss1M -XX:+CMSClassUnloadingEnabled -XX:MaxPermSize=384M -Dsbt.boot.directory=%REPO%\boot -Dsbt.ivy.home=%REPO% -jar "%SCRIPT_DIR%\bin\sbt-launch.jar" %*
goto end
:nojavahome
