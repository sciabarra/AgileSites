...
cd core
call sbt "core118/sitesTagWrapperGen %jsk%" "core118/publish-local" "core118/publishM2" "core118/publish"
cd ..
cd api
call sbt "api118/publish-local" "api118/publishM2" "api118/publish"
cd ..
goto end
:nofile
