...
public final class StringUtils {
	...
	/**
	 * Takes a human readable size representation eg 10K a long value. Doesn't
	 * support 1.1K or other rational values.
	 * 
	 * @param humanSize
	...
	/**
	 * Removes the suffix from a given string, if the string contains that
	 * suffix.
	 * 
	 * @param string
	 *            String for check
	...
	/**
	 * Removes the prefix from a given string, if the string contains that
	 * prefix.
	 * 
	 * @param string
	 *            String for check
